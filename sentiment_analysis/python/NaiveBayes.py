...
from solve import SolveSentimentProblem

class NaiveBayes:
  solve_sentiment_problem = SolveSentimentProblem()
  class TrainSplit:
  ...
  def classify(self, words):
    ...
    """
    # return 'pos'
    postive_score, negtive_score = self.solve_sentiment_problem.compute_score(words)
    if postive_score > negtive_score:
      return "pos"
    else: return "neg"
  ...
  def addExample(self, klass, words):
    ...
    self.solve_sentiment_problem.compute_words(klass, words)
